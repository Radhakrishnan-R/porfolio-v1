export const navItems = [
  ...
  export const skills = ["Reactjs", "Nextjs", "Javascript", "Node.js", "Express.js", "PostgresSql", "SQL", "OAuth2.0"];
  ...
  export const gridItems = [
    ...
    },
    {
      id: 3,
      title: "My tech stack",
      description: "I create code that's cleaner than my room.",
      className: "lg:col-span-2 md:col-span-3 ",
      imgClassName: "",
    ...
    {
      id: 4,
      title: "My debugger and I are in a love-hate relationship.",
      description: "",
      className: "lg:col-span-2 md:col-span-3 ",
      imgClassName: "",
      titleClassName: "justify-start",
    ...
    {
      id: 5,
      title: "Breaking code since ['2023'], fixing it since 5 minutes ago.",
  ...
  export const projects = [
    ...
    {
      id: 2,
      title: "Footwear for Every Style",
